...
public class CustomSettingsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private File m10286l() {
        return new File(C2714o.m10947a(this), this.f7010o);
    }
    ...
    private void m10287m() {
        if (C2714o.m10955a(this, 1)) {
            try {
                C2714o.m10950a((Activity) this, getString(R.string.settings_ware_exported_successfully, new Object[]{m10280a(false, false)}), false);
            } catch (Exception e) {
    ...
    private void m10289o() {
        try {
            Document k = m10285k();
            k.getDocumentElement().setAttribute("Name", C2714o.m10948a(this, this.f7012q.getText().toString(), "Custom"));
            C2714o.m10953a(new File(C2714o.m10947a(this), "Custom_" + new SimpleDateFormat("yyyyMMddHHmmsszzz", Locale.ENGLISH).format(new Date()) + ".xml"), k);
            C2709k.m10913a(new Date());
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        if (i != 1 && i != 2) {
            ...
            C2714o.m10949a((Activity) this, (int) R.string.request_write_external_storage_permission, false);
        } else if (i == 1) {
            m10287m();
        } else if (i == 2) {
            m10289o();
