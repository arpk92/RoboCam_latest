...
public class C2671a implements Camera.PreviewCallback {
    ...
    /* renamed from: w */
    private C2706h[] f7406w = null;

    /* renamed from: x */
    private List<C2706h> f7407x = new ArrayList();
    ...
    /* renamed from: q */
    private C2706h m10553q() {
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList();
        int i = this.f7392i.f7567a;
        int i2 = this.f7392i.f7568b;
        C2706h[] hVarArr = this.f7406w;
        for (C2706h hVar : hVarArr) {
            if (hVar.f7568b == (hVar.f7567a * i2) / i) {
                if (hVar.f7567a < i || hVar.f7568b < i2) {
                    arrayList2.add(hVar);
                } else {
                    arrayList.add(hVar);
                }
        ...
        return arrayList.size() > 0 ? (C2706h) Collections.min(arrayList, new C2697b()) : arrayList2.size() > 0 ? (C2706h) Collections.max(arrayList2, new C2697b()) : this.f7392i;
    }
    ...
    public void m10554r() {
        try {
            if (Build.VERSION.SDK_INT >= 23 && this.f7409z != null && this.f7366A == null && !this.f7393j) {
                C2706h q = m10553q();
                this.f7372G.setDefaultBufferSize(q.f7567a, q.f7568b);
    ...
    /* renamed from: v */
    private C2706h m10558v() {
        if (this.f7407x == null || this.f7407x.size() == 0) {
            return null;
        }
        if (this.f7391h < 0) {
            C2706h hVar = this.f7407x.get(0);
            C2706h hVar2 = this.f7407x.get(this.f7407x.size() - 1);
            int round = Math.round(((float) this.f7407x.size()) / 3.0f);
            if (hVar.f7567a > hVar2.f7567a || hVar.f7568b > hVar2.f7568b) {
    ...
    public void mo7637a(Activity activity, View view, int i, int i2) {
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            if (b == 90 || b == 270) {
                RectF rectF2 = new RectF(0.0f, 0.0f, (float) this.f7392i.f7568b, (float) this.f7392i.f7567a);
                rectF2.offset(centerX - rectF2.centerX(), centerY - rectF2.centerY());
                matrix.setRectToRect(rectF, rectF2, Matrix.ScaleToFit.FILL);
                float max = Math.max(((float) i2) / ((float) this.f7392i.f7568b), ((float) i) / ((float) this.f7392i.f7567a));
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                if (ActivityCompat.checkSelfPermission((Context) activity, "android.permission.CAMERA") == 0) {
                    ...
                    try {
                        ...
                        this.f7406w = new C2706h[outputSizes.length];
                        HashSet hashSet = new HashSet();
                        for (int i = 0; i < outputSizes.length; i++) {
                            this.f7406w[i] = new C2706h(outputSizes[i]);
                        ...
                        for (int i2 = 0; i2 < outputSizes2.length; i2++) {
                            if (hashSet.contains(Float.valueOf(((float) outputSizes2[i2].getHeight()) / ((float) outputSizes2[i2].getWidth())))) {
                                this.f7407x.add(new C2706h(outputSizes2[i2]));
                            }
                        }
                        ...
                        m10556t();
                        m10559w();
                        this.f7373H = ImageReader.newInstance(this.f7392i.f7567a, this.f7392i.f7568b, 35, 2);
            ...
            if (Build.VERSION.SDK_INT < 23) {
                ...
                if (this.f7389f != null) {
                    ...
                    for (int i = 0; i < supportedPreviewSizes.size(); i++) {
                        this.f7407x.add(new C2706h(supportedPreviewSizes.get(i)));
                    }
                    try {
        ...
        synchronized (HttpServer.f7136a) {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                if (Build.VERSION.SDK_INT < 23) {
                    ...
                    parameters.setPreviewSize(this.f7392i.f7567a, this.f7392i.f7568b);
                    parameters.setJpegQuality(100);
                    this.f7389f.setParameters(parameters);
                }
                if (!(this.f7385a == this.f7392i.f7567a && this.f7386b == this.f7392i.f7568b)) {
                    z = true;
                }
                this.f7385a = this.f7392i != null ? -1 : this.f7392i.f7567a;
                if (this.f7392i != null) {
                    i = this.f7392i.f7568b;
                }
                this.f7386b = i;
